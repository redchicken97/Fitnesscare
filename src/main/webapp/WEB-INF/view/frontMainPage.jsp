			...
			<div class="row text-center">
				<div style="margin-left: -20px;" class="col-lg-12">
					<div style="text-align:center;">
						<div style="background-image: url('/resources/img/boxing.png'); background-repeat: no-repeat; color: white; text-align: center; font-weight: bold; font-size: 40px;" class="zoom"><p style="padding-top: 170px;">Boxing</p></div>
