...
<%@ page import="com.fitness.admin.user.dao.UserManDAO"%>
<%@ page import="com.fitness.admin.user.vo.UserManVO"%>
...
<table border="1">
	...
	<tr>
		<td><a href="/getUserInfo.admin?user_id=${user.user_id}">${user.user_id}</a></td>
...
<ul> 
	<c:if test="${pageMaker.prev}">
		<li><a href="/getUserInfoList.admin${pageMaker.makeQuery(pageMaker.startPage - 1)}"><</a></li>
	</c:if>
	<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
		<li><a href="/getUserInfoList.admin${pageMaker.makeQuery(idx)}">${idx}</a></li>
	</c:forEach>
	<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
		<li><a href="/getUserInfoList.admin${pageMaker.makeQuery(pageMaker.endPage + 1)}">></a></li>
	</c:if>
</ul>
<br />
</body>
